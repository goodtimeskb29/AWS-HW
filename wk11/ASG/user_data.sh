...
<head>
    ...
    <title>I love Baby Nicols</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <h1>I Love Baby Nicols</h1>
        <h2>Venezuela For The Win</h2>
        
        <image src="https://pbs.twimg.com/media/GemuBvyWUAAMgJJ?format=jpg&name=large" alt="baby" class="hero-image">
